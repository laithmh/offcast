  ...
  group('WebRtcStatsCalculator Unit Tests', () {
    ...
    test('calculateOutbound calculates fps and bitrate from delta reports', () {
      final initialReports = [
        StatsReport('outbound-1', 'outbound-rtp', 1000.0, {
          'kind': 'video',
          'framesEncoded': 60,
          'bytesSent': 250000,
          'frameWidth': 1920,
      ...
      final secondReports = [
        StatsReport('outbound-1', 'outbound-rtp', 2000.0, {
          'kind': 'video',
          'framesEncoded': 120,
          'bytesSent': 500000,
          'frameWidth': 1920,
        ...
        StatsReport('pair-1', 'candidate-pair', 2000.0, {
          'state': 'succeeded',
    ...
    test('calculateInbound calculates decoded frames and RTT', () {
      final initialReports = [
        StatsReport('inbound-1', 'inbound-rtp', 1000.0, {
          'kind': 'video',
          'framesDecoded': 30,
